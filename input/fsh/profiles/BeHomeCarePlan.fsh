...
* author only Reference(BePatient or BePractitioner or BePractitionerRole or BeOrganization or BeHomeCareTeam)
* author MS
* contributor only Reference(BePatient or BePractitioner or BePractitionerRole or BeOrganization or BeHomeCareTeam)
* contributor MS
* careTeam only Reference(BeHomeCareTeam)
* careTeam MS
* goal MS
* activity MS
...
* activity.detail.performer only Reference(BePatient or BePractitioner or BePractitionerRole or BeOrganization or BeHomeCareTeam)
